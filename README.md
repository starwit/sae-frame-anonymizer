...
| `anonymization.blur_strength` | `0.15` | Gaussian sigma as a fraction of the smaller bounding box dimension, so the perceived blur strength does not depend on how large/close an object is. Raise it for stronger anonymization. |
